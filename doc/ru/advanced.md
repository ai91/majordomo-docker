...
Теперь можно установить и настраивть модуль MQTT в MajorDoMo. Для этого открываем панель управления, устанавливаем модуль и настраиваем его для работы с брокером: он доступен на этой же машине по порту `1883`.
...
if [ -z "$(ls -A /var/www/html/cms)" ]; then
    ...
    find /var/www/html/cms/ -type d -exec chmod 777 {} && chown www-data:www-data {} \;
    find /var/www/html/cms/ -type f -exec chmod 666 {} && chown www-data:www-data {} \;
fi
...
if [ -z "$(ls -A /var/www/html/modules)" ]; then
    ...
    find /var/www/html/modules/ -type d -exec chmod 777 {} && chown www-data:www-data {} \;
    find /var/www/html/modules/ -type f -exec chmod 666 {} && chown www-data:www-data {} \;
fi
